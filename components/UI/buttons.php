        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_IN_COMPONENTS_PATH ?>/UI/buttons.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buttons</p>
                </a>
              </li>
...
<!-- Bootstrap 4 -->
<script src=<?php echo FILE_SUB_ASSETS_JS_ADMIN_PATH ?>/bootstrap.bundle.min.js></script>
<!-- AdminLTE App -->
