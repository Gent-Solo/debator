...
<head>
  ...
  <!-- SweetAlert2 -->
  <link rel="stylesheet" href=<?php echo FILE_SUB_ASSETS_CSS_ADMIN_PATH ?>/sweetalert2.min.css>
  <!-- Toastr -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_IN_COMPONENTS_PATH ?>/UI/navbar.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Navbar & Tabs</p>
                </a>
              </li>
