...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/main.css>
  <!-- Theme style -->
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href=<?php echo FILE_COMPONENTS_PATH ?>/calendar.php class="nav-link active">
...
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/main.js></script>
