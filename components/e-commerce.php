        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/e-commerce.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>E-commerce</p>
                </a>
              </li>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-1.jpg class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-1.jpg alt="Product Image"></div>
                <div class="product-image-thumb" ><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-2.jpg alt="Product Image"></div>
                <div class="product-image-thumb" ><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-3.jpg alt="Product Image"></div>
                <div class="product-image-thumb" ><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-4.jpg alt="Product Image"></div>
                <div class="product-image-thumb" ><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/prod-5.jpg alt="Product Image"></div>
              </div>
            </div>
            <div class="col-12 col-sm-6">
