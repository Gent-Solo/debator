...
<head>
  ...
  <!-- CodeMirror -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/codemirror.css>
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/monokai.css>
</head>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/editors.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Editors</p>
                </a>
              </li>
...
<!-- CodeMirror -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/codemirror.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/css.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/xml.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/htmlmixed.js></script>
