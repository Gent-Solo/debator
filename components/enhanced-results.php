        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/enhanced.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Enhanced</p>
                </a>
              </li>
                ...
                <div class="col-md-10 offset-md-1">
                    <div class="list-group">
                        ...
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-auto">
                                    <img class="img-fluid" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Photo" style="max-height: 160px;">
                                </div>
                                <div class="col px-4">
                                    <div>
