...
<!-- FLOT CHARTS -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.flot.js></script>
<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.flot.resize.js></script>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.flot.pie.js></script>
