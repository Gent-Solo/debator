...
<head>
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/jqvmap.min.css>
  <!-- Theme style -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/summernote-bs4.min.css>
</head>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/AdminLTELogo.png alt="AdminLTELogo" height="60" width="60">
  </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/index.php class="nav-link active">
...
<!-- jQuery UI 1.11.4 -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery-ui.min.js></script>
...
<!-- JQVMap -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.vmap.min.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.vmap.usa.js></script>
<!-- jQuery Knob Chart -->
...
<!-- Summernote -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/summernote-bs4.min.js></script>
<!-- overlayScrollbars -->
...
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/dashboard.js></script>
</body>
</html>
