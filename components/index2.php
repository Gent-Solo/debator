...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/AdminLTELogo.png alt="AdminLTELogo" height="60" width="60">
  </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/index2.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v2</p>
                </a>
              </li>
                  ...
                  <div class="card-body">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user1-128x128.jpg alt="message user image">
                        <!-- /.direct-chat-img -->
                      ...
                      <div class="direct-chat-msg right">
                        ...
                        <!-- /.direct-chat-infos -->
                        <img class="direct-chat-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user3-128x128.jpg alt="message user image">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                    ...
                    <div class="direct-chat-contacts">
                      <ul class="contacts-list">
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user1-128x128.jpg alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user7-128x128.jpg alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user3-128x128.jpg alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user5-128x128.jpg alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user6-128x128.jpg alt="User Avatar">
                        ...
                        <li>
                          <a href="#">
                            <img class="contacts-list-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user8-128x128.jpg alt="User Avatar">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      ...
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user8-128x128.jpg alt="User Image">
                        <a class="users-list-name" href="#">Norman</a>
                        <span class="users-list-date">Yesterday</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user7-128x128.jpg alt="User Image">
                        <a class="users-list-name" href="#">Jane</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user6-128x128.jpg alt="User Image">
                        <a class="users-list-name" href="#">John</a>
                        <span class="users-list-date">12 Jan</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user2-160x160.jpg alt="User Image">
                        <a class="users-list-name" href="#">Alexander</a>
                        <span class="users-list-date">13 Jan</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user5-128x128.jpg alt="User Image">
                        <a class="users-list-name" href="#">Sarah</a>
                        <span class="users-list-date">14 Jan</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user4-128x128.jpg alt="User Image">
                        <a class="users-list-name" href="#">Nora</a>
                        <span class="users-list-date">15 Jan</span>
                      </li>
                      <li>
                        <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user3-128x128.jpg alt="User Image">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href=<?php echo FILE_COMPONENTS_PATH ?>/invoice.php>OR9842</a></td>
                    ...
                    <tr>
                      <td><a href=<?php echo FILE_COMPONENTS_PATH ?>/invoice.php>OR1848</a></td>
                    ...
                    <tr>
                      <td><a href=<?php echo FILE_COMPONENTS_PATH ?>/invoice.php>OR7429</a></td>
                      <td>iPhone 6 Plus</td>
                ...
                <ul class="products-list product-list-in-card pl-2 pr-2">
                  <li class="item">
                    <div class="product-img">
                      <img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/default-150x150.png alt="Product Image" class="img-size-50">
                    </div>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.mousewheel.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/raphael.min.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.mapael.min.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/usa_states.min.js></script>
<!-- ChartJS -->
...
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/dashboard2.js></script>
</body>
</html>
