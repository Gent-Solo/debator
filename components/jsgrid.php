...
<head>
  ...
  <!-- jsGrid -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/jsgrid.min.css>
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/jsgrid-theme.min.css>
  <!-- Theme style -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/tables/jsgrid.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>jsGrid</p>
                </a>
              </li>
...
<!-- jsGrid -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/db.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jsgrid.min.js></script>
<!-- AdminLTE App -->
