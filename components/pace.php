...
<head>
  ...
  <!-- pace-progress -->
  <link rel="stylesheet" href=<?php echo FILE_ASSETS_CSS_ADMIN_PATH ?>/pace-theme-flat-top.css>
  <!-- adminlte-->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/pace.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pace</p>
                </a>
              </li>
...
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/js/bootstrap.bundle.min.js></script>
  <!-- pace-progress -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/pace.min.js></script>
<!-- AdminLTE App -->
