        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/profile.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Profile</p>
                </a>
              </li>
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user4-128x128.jpg
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user1-128x128.jpg alt="user image">
                        <span class="username">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user7-128x128.jpg alt="User Image">
                        <span class="username">
                          <a href="#">Sarah Ross</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                    ...
                    <div class="post">
                      <div class="user-block">
                        <img class="img-circle img-bordered-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user6-128x128.jpg alt="User Image">
                        <span class="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" class="float-right btn-tool"><i class="fas fa-times"></i></a>
                        </span>
                      ...
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <img class="img-fluid" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Photo">
                        </div>
                        <!-- /.col -->
                        <div class="col-sm-6">
                          <div class="row">
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo2.png alt="Photo">
                              <img class="img-fluid" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo3.jpg alt="Photo">
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                              <img class="img-fluid mb-3" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo4.jpg alt="Photo">
                              <img class="img-fluid" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Photo">
                            </div>
                            <!-- /.col -->
                          </div>
