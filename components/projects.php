        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/projects.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Projects</p>
                </a>
              </li>
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/avatar.png>
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/avatar2.png>
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/avatar3.png>
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/avatar4.png>
                              </li>
                          </ul>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/avatar5.png>
                              </li>
                          </ul>
                      </td>
                      <td class="project_progress">
