        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/read-mail.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Read</p>
                </a>
              </li>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-footer bg-white">
              <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo2.png alt="Attachment"></span>
