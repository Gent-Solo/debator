...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      ...
      <form action=<?php echo FILE_COMPONENTS_PATH ?>/index.php method="post">
      ...
      <a href=<?php echo FILE_COMPONENTS_PATH ?>/login.php class="text-center">I already have a membership</a>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
</div>
