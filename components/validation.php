        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href=<?php echo FILE_COMPONENTS_PATH ?>/validation.php class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Validation</p>
                </a>
              </li>
...
<!-- jquery-validation -->
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/jquery.validate.min.js></script>
<script src=<?php echo FILE_ASSETS_JS_ADMIN_PATH ?>/additional-methods.min.js></script>
<!-- AdminLTE App -->
