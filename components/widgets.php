    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href=<?php echo FILE_COMPONENTS_PATH ?>/widgets.php class="nav-link active">
        ...
        <div class="row">
            ...
            <div class="card card-widget widget-user-2">
              ...
              <div class="widget-user-header bg-warning">
                <div class="widget-user-image">
                  <img class="img-circle elevation-2" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user7-128x128.jpg alt="User Avatar">
                </div>
                <!-- /.widget-user-image -->
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-image">
                <img class="img-circle elevation-2" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user1-128x128.jpg alt="User Avatar">
              </div>
              <div class="card-footer">
                <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white"
                   style="background: url(<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png) center center;">
                <h3 class="widget-user-username text-right">Elizabeth Pierce</h3>
                <h5 class="widget-user-desc text-right">Web Designer</h5>
              </div>
              <div class="widget-user-image">
                <img class="img-circle" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user3-128x128.jpg alt="User Avatar">
              </div>
              <div class="card-footer">
                <div class="row">
                  <div class="col-sm-4 border-right">
            ...
            <div class="card card-widget">
              <div class="card-header">
                <div class="user-block">
                  <img class="img-circle" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user1-128x128.jpg alt="User Image">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <img class="img-fluid pad" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo2.png alt="Photo">
              ...
              <div class="card-footer card-comments">
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user3-128x128.jpg alt="User Image">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user4-128x128.jpg alt="User Image">
              ...
              <div class="card-footer">
                <form action="#" method="post">
                  <img class="img-fluid img-circle img-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user4-128x128.jpg alt="Alt Text">
            ...
            <div class="card card-widget">
              ...
              <div class="card-body">
                ...
                <div class="attachment-block clearfix">
                  <img class="attachment-img" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Attachment Image">
              ...
              <div class="card-footer card-comments">
                ...
                <div class="card-comment">
                  <!-- User image -->
                  <img class="img-circle img-sm" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/user5-128x128.jpg alt="User Image">
            ...
            <div class="row">
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2 bg-gradient-dark">
                  <img class="card-img-top" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo1.png alt="Dist Photo 1">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo2.png alt="Dist Photo 2">
              ...
              <div class="col-md-12 col-lg-6 col-xl-4">
                <div class="card mb-2">
                  <img class="card-img-top" src=<?php echo FILE_ASSETS_IMG_ADMIN_PATH ?>/photo3.jpg alt="Dist Photo 3">
